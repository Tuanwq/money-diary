      ...
      <section className="app-card rounded-2xl p-4 sm:p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h3 className="mt-1 text-xl font-bold">Kế hoạch ngày mai</h3>
    ...
    <section className="rounded-2xl bg-white p-4 shadow-sm sm:p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <h3 className="mt-1 text-xl font-bold">Phát hiện mất tiền / lệch tiền</h3>
          <p className="mt-1 text-sm text-slate-500">
      ...
      <div className="mt-5 rounded-2xl border p-3 sm:p-4">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h4 className="text-lg font-bold">Dữ liệu lệch tiền ngày cũ</h4>
            <p className="mt-1 text-sm text-slate-500">
    ...
    <article className="rounded-2xl border p-3">
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          ...
          <h5 className="mt-1 font-bold">{audit.statusText}</h5>
        </div>
    ...
    <article className="rounded-2xl border p-4">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <h4 className="mt-1 break-words font-bold">{goal.name}</h4>
        </div>
